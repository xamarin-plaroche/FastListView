...
namespace FastListView.Renderers
{
    ...
    {
        public FastListViewRenderer(Context context) : base(context)
        {
        }
...
#pragma warning restore 0219
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<FastListView.Forms.VisualElements.FastListView> e)
        {
