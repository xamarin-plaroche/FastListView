...
namespace FastListView.Renderers
{
	public class RecyclerViewAdapter : RecyclerView.Adapter, Android.Views.View.IOnClickListener
	{
		...
		private readonly Forms.VisualElements.FastListView _fastListView;
		private readonly IList _dataSource;

		public RecyclerViewAdapter(Forms.VisualElements.FastListView listView)
		{
		...
		public float CalculateHeightForCell(Forms.VisualElements.FastListView fastListView, ViewCell cell)
		{
